...
const terms: Record<string, string> = {
  "credential stuffing": "Attackers use username/password pairs leaked from breaches at other companies to try logging into your site — automated bots test millions of combos hoping users reused passwords.",
  ...
  "DDoS": "Distributed Denial-of-Service — thousands of compromised machines flood your servers with traffic simultaneously, overwhelming capacity and taking the site offline.",
  "WAF": "Web Application Firewall — inspects HTTP traffic and blocks requests matching known attack patterns (SQL injection, XSS, etc.) before they reach your application.",
  "inventory scraping": "Competitor bots systematically crawl your product pages to extract pricing, stock levels, and catalog data for competitive intelligence.",
